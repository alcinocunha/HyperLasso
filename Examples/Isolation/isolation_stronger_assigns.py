...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("Usage: python isolation_stronger_assigns.py <transactions> <keys> <values>")
        sys.exit(1)
    ...
    print("Forall A . Exists B . !(" + init("A") + " & " + all_installed("A") + " & (" + same_transactions("A","B") + " -> !(" + all_installed("B") + ")))" )